...
def main() -> int:
    ...
    print(
        ...
        f"image_url_coverage={report.metrics['image_url_coverage']} "
        f"image_license_metadata_coverage="
        f"{report.metrics['image_license_metadata_coverage']} "
        f"image_cache_metadata_coverage="
        f"{report.metrics['image_cache_metadata_coverage']} "
